...
async fn add_tag_case_1(pool: PgPool) {
    ...
    let res = repo.add_tag(article.id, tag_id, version, &mut tx).await;
...
async fn add_tag_case_article_not_found(pool: PgPool) {
    let repo = PgArticleRepository::new();
...
async fn add_tag_case_tag_not_found(pool: PgPool) {
    let repo = PgArticleRepository::new();
...
async fn add_tag_case_both_not_found(pool: PgPool) {
...
async fn add_tag_case_concurrent_conflict(pool: PgPool) {
    let repo = PgArticleRepository::new();
